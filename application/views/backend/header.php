<!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="#"><b><img src="<?php echo base_url();?>uploads/logo.png" width="50" height="50" alt="home" /></b><span class="hidden-xs"><strong>EET</strong> 172</span></a></div>
               ...
               <ul class="nav navbar-top-links navbar-right pull-right">
					...
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
								<?php
                                    ...
                                    // --- INICIO PARCHE: usar tabla language en vez de language_list ---
                                    ...
                                    $lid = $set_lang;
                                    $lnm = ucfirst($set_lang);
                                    // --- FIN PARCHE ---
                                ?>
						<img src="<?php echo base_url(); ?>optimum/flag/<?php echo $lid; ?>.png" style="width:20px; height:20px;" /></a>
                           ...
                           <?php
                                    // --- INICIO PARCHE: obtener idiomas desde columnas de language ---
                                    // $langs = $this->db->get_where('language_list', array('status' => 'ok'))->result_array();
                                    $fields = $this->db->list_fields('language');
                                    $langs = array();
                                    foreach ($fields as $field) {
                                        if ($field != 'phrase_id' && $field != 'phrase') {
                                            $langs[] = array('db_field' => $field, 'name' => ucfirst($field));
                                        }
                                    }
                                    foreach ($langs as $row) {
                                ?>
                                    <li <?php if ($set_lang == $row['db_field']) { ?>class="active"<?php } ?> >
                                        <a class="set_langs pointer" data-href="<?php echo base_url(); ?>admin/set_language/<?php echo $row['db_field']; ?>" style="color:#96a2b4">
										 <img src="<?php echo base_url(); ?>optimum/flag/<?php echo $row['db_field']; ?>.png" style="width:16px; height:16px;" />	
                                            <?php echo $row['name']; ?>
